...
import { BsKanban, BsBarChart, BsBoxSeam, BsCurrencyDollar, BsShield, BsChatLeft,BsStackOverflow } from 'react-icons/bs';
...
export const links = [
...

  {
    ...
    links: [
      {
        address: 'Addcert',
        name: 'Cấp mới, thu hồi, gia hạn giấy chứng nhận',
        icon: <AiOutlineShoppingCart />,
      },
      {
        address: 'Safety',
        name: 'Các cơ sở đủ điều kiện an toàn thực phẩm',
        icon: <IoMdContacts />,
      },
      {
        address: 'Unsafety',
        name: 'Các cơ sở chưa đủ điều kiện an toàn thực phẩm',
        icon: <RiContactsLine />,
      },
    ],
  },
  {
    title: 'Quản lý hoạt thông thanh, kiểm tra',
    links: [
      {
        address: 'Plan',
        name: 'Lập kế hoạch thanh, kiểm tra',
        icon: <AiOutlineCalendar />,
      },
      {
        address: 'Follow',
        name: 'Theo dõi thực hiện kế hoạch thanh, kiểm tra',
        icon: <BsKanban />,
      },
      {
        address: 'Statistic',
        name: 'Thống kê kết quả thực hiện thanh, kiểm tra',
        icon: <FiEdit />,
      },
      {
        address: 'Manage',
        name: 'Quản lý các mẫu thực phẩm cần/được giám định',
        icon: <BiColorFill />,
      },
    ],
  },
